            ...
            <Col lg="6">
              <div className="pl-lg-4 pt-5 pt-lg-0">
                ...
                >
                  ...
                  Experienced in creating mobile apps with minimal and beautiful design.
                </Text>
                <div className="mt-4">
                  <Text color="light">Reach me</Text>
                  ...
                  <Text variant="p">
                    ...
                    >
                      <Span color="light">ariqhm@gmail.com</Span>
                      <Span color="light">heritsam@student.telkomuniversity.ac.id</Span>
                    </a>
                  </Text>
                </div>
                <div className="mt-5">
                ...
                <div className="mt-5 d-flex">
                  ...
                  <LinkSocial
                    href="https://www.github.com/Heritsam"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mr-3"
                  >
                  ...
                  <LinkSocial
                    href="https://www.instagram.com/heritsam_"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-weight-bold"
                  >
